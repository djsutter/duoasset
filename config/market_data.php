...
return [
    ...
    */
    'buy_setup_scanner' => [
        ...
        'max_symbols_per_run' => env('BUY_SETUP_MAX_SYMBOLS', 4000),
        ...
        'min_base_days' => env('BUY_SETUP_MIN_BASE_DAYS', 45),
        'max_base_days' => env('BUY_SETUP_MAX_BASE_DAYS', 120),
        'max_range_compression_pct' => env('BUY_SETUP_MAX_RANGE_COMPRESSION_PCT', 40),
        ...
        'score_weights' => [
            'spike_rarity' => env('BUY_SETUP_SCORE_SPIKE_RARITY_WEIGHT', 25),
            'base_duration' => env('BUY_SETUP_SCORE_BASE_DURATION_WEIGHT', 10),
            'range_compression' => env('BUY_SETUP_SCORE_RANGE_COMPRESSION_WEIGHT', 15),
            'atr_contraction' => env('BUY_SETUP_SCORE_ATR_CONTRACTION_WEIGHT', 10),
            'volume_dry_up' => env('BUY_SETUP_SCORE_VOLUME_DRY_UP_WEIGHT', 10),
            'breakout_distance' => env('BUY_SETUP_SCORE_BREAKOUT_DISTANCE_WEIGHT', 10),
            'ma_alignment' => env('BUY_SETUP_SCORE_MA_ALIGNMENT_WEIGHT', 10),
            'relative_strength' => env('BUY_SETUP_SCORE_RELATIVE_STRENGTH_WEIGHT', 10),
            'earnings_acceleration' => env('BUY_SETUP_SCORE_EARNINGS_ACCELERATION_WEIGHT', 5),
            'sales_acceleration' => env('BUY_SETUP_SCORE_SALES_ACCELERATION_WEIGHT', 5),
        ],
        'notification_email' => env('BUY_SETUP_NOTIFICATION_EMAIL', 'j@7pro.ca'),
    ],
