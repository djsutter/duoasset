...
use App\Data\Imports\AvianRowData;
...
class AvianMapper extends BaseMapper
{
    protected string $platformName = 'Avian';

    public function map(AvianRowData $dto): ?StageTransactionImportData
    {
    ...
    private function mapReceive(AvianRowData $dto): ?StageTransactionImportData
    {
    ...
    private function mapSend(AvianRowData $dto): ?StageTransactionImportData
    {
